...
export const initConfigSeed: Seed = {
  ...
  async run(executor) {
    const configs = [
      {
        name: "启用部门管理",
        key: "sys_dept_enabled",
        value: "true",
        type: 2,
        group: "system",
        remark: "是否在用户管理页面显示部门树",
      },
      {
        name: "用户初始密码",
        key: "sys_user_init_password",
        value: "123456",
        type: 0,
        group: "user",
        remark: "新建用户和重置密码时的默认密码",
      },
      {
        name: "密码最小长度",
        key: "sys_password_min_length",
        value: "6",
        type: 1,
        group: "password",
        remark: "用户密码最小长度要求",
      ...
      {
        name: "密码复杂度要求",
        key: "sys_password_complexity",
        value: "low",
        type: 0,
        group: "password",
        remark: "low=无要求, medium=字母+数字, high=字母+数字+特殊字符",
      },
      {
        name: "密码过期天数",
        key: "sys_password_expire_days",
        value: "30",
        type: 1,
        group: "password",
        remark: "-1 表示永不过期",
      ...
      },
      {
        ...
        type: 2,
        group: "mfa",
        remark: "开启后未配置MFA的用户首次登录后必须设置MFA",
      },
      {
        name: "启用Passkey通行密钥",
        key: "sys_passkey_enabled",
        value: "true",
        type: 2,
        group: "passkey",
