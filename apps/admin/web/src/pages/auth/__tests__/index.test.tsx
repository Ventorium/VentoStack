...
describe('登录页', () => {
  ...
  test('只有开启自注册配置时才显示注册入口', () => {
    const showRegister = (registerEnabled: boolean) => registerEnabled;
    expect(showRegister(true)).toBe(true);
    expect(showRegister(false)).toBe(false);
  });
