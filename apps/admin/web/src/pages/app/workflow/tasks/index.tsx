...
import { Card, Input, Modal, Table, Tag, message } from 'antd';
          ...
          items={[
            ...(r.status === 0
              ? [
                  {
                    label: '通过',
                    onClick: () => setCommentModal({ taskId: r.id, action: 'approve' }),
                  },
                  {
                    label: '驳回',
                    onClick: () => setCommentModal({ taskId: r.id, action: 'reject' }),
                    danger: true,
                  },
                ]
              : []),
